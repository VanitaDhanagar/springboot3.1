...
public class SalesOrderController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<?> createSalesOrder(@RequestBody final SalesOrder salesOrder)
	...
	@ResponseBody
	public ResponseEntity<?> updateSalesOrder(@PathVariable("salesOrderId") final String salesOrderId,
		...
		if (salesOrderService.getById(salesOrderId) != null) {
			...
			if (statusCode.equalsIgnoreCase("S")) {
				try {
					...
					logger.info("get response value:", response.getStatusCode());
	...
	public ResponseEntity<?> getSalesOrdersByCustomerEmail(
...
System.out.println("customerEmail:"+customerEmail);
	...
	public ResponseEntity<?> getSalesOrderById(@PathVariable("salesOrderId") final String salesOrderId) {
