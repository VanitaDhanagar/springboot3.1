...
public class ProductController {
	...
	public ResponseEntity<?> getProductById(@PathVariable(value = "id") final String productId) {
	...
	public ResponseEntity<?> getStockByProductId(@PathVariable(value = "id") final String productId) {
